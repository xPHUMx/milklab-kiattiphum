...
def parse_command(cmd: str, api_key: str | None = None) -> dict:
    ...
    1. log_sale: บันทึกยอดขายลงระบบ
       - menu (string): ชื่อเมนูอาหาร/เครื่องดื่ม/เจลาโต้ เช่น นมหมีฮอกไกโด, นมโกโก้บราวนี่, เจลาโต้นมสดฮอกไกโด, เจลาโต้ดาร์กช็อกโกแลต
       - qty (integer): จำนวนชิ้น/ขวด/ถ้วย/หน่วย
