...
def parse_command(cmd: str, api_key: str | None = None) -> dict:
    ...
    1. log_sale: บันทึกยอดขายลงระบบ
       - menu (string): ชื่อเมนูเจลาโต้ เช่น เจลาโต้นมสดฮอกไกโด, เจลาโต้ดาร์กช็อกโกแลต, เจลาโต้สตรอว์เบอร์รีซอร์เบต์, เจลาโต้ชาเขียวมัทฉะ, เจลาโต้มะม่วงมหาชนกซอร์เบต์
       - qty (integer): จำนวนถ้วย/หน่วย
